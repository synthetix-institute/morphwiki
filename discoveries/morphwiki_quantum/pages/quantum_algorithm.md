...
---
Wikipedia scaffold: [Quantum algorithm](https://en.wikipedia.org/wiki/Quantum_algorithm) (CC BY-SA). Evidence from Wikipedia scaffold and 32 equation witnesses.
