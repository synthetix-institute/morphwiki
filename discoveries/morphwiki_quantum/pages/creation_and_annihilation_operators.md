...
- **operator:** Hamiltonian; commutator
- **spectrum:** eigenvalue; energy level; measurement outcome
- **boundary:** context
- **incompatibility:** commutator
- **protocol:** unitary evolution; projection or measurement update; path integral weighting

## Evidence Profile
- Routes: operator and spectrum: 0.27, state evolution / transport: 0.26, non-commuting transformations: 0.21, closure / conservation: 0.20, boundary or preparation: 0.07, update protocol: 0.05
...
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.505
- [2111.12617](https://arxiv.org/abs/2111.12617) — score 0.503
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.502
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.500
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.500
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.491
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.484
- [1709.09547](https://arxiv.org/abs/1709.09547) — score 0.474

---
Wikipedia scaffold: [Creation and annihilation operators](https://en.wikipedia.org/wiki/Creation_and_annihilation_operators) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
