...
- Spectral terms (eigenvalue, energy level, or eigenstate) name the outcome labels and projectors that define readout channels.
...
- **operator:** Hamiltonian; observable operator; matrix
- **spectrum:** eigenvalue; energy level
- **boundary:** basis
...
## Evidence Profile
- Routes: operator and spectrum: 0.43, state evolution / transport: 0.26, closure / conservation: 0.19, boundary or preparation: 0.06, update protocol: 0.05, non-commuting transformations: 0.05
...
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.562
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.557
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.551
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.545
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.543
- [0805.4565](https://arxiv.org/abs/0805.4565) — score 0.525
- [2108.07838](https://arxiv.org/abs/2108.07838) — score 0.521

---
Wikipedia scaffold: [Quantum chaos](https://en.wikipedia.org/wiki/Quantum_chaos) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
