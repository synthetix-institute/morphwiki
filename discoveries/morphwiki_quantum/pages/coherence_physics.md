...
- **spectrum:** spectrum
- **boundary:** potential or domain condition; detector; basis
...
## Evidence Profile
- Routes: operator and spectrum: 0.37, state evolution / transport: 0.18, boundary or preparation: 0.12, closure / conservation: 0.10, update protocol: 0.10, non-commuting transformations: 0.04
...
---
Wikipedia scaffold: [Coherence (physics)](https://en.wikipedia.org/wiki/Coherence_(physics)) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
