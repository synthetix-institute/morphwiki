...
- Operator terms (generator, matrix, or Hamiltonian) name the observable, Hamiltonian, unitary, or constraint acting on the carrier.
...
## Evidence Profile
- Routes: operator and spectrum: 0.39, state evolution / transport: 0.25, closure / conservation: 0.19, boundary or preparation: 0.12, update protocol: 0.07, non-commuting transformations: 0.05
...
---
Wikipedia scaffold: [Gauge theory](https://en.wikipedia.org/wiki/Gauge_theory) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
