...
## Evidence Status
The density matrix can be read as a quantum construction: the chosen basis, pulse sequence, or measurement axis fixes the admissible state space; a Hamiltonian or unitary matrix rotating that state between preparation and measurement defines the transformation or question; and spectral projectors with the Born rule determine the recorded probability distribution.

## The Standard Story
In quantum mechanics, a density matrix is a matrix used in calculating the probabilities of the outcomes of measurements performed on physical systems. It is a generalization of the state vectors or wavefunctions: while those can only represent pure states, density matrices can also represent mixed ensembles of states.

## Mechanism Reading
In quantum-mechanical terms, the Density matrix is described by a two-dimensional Hilbert space, usually written as a qubit state or a density matrix. The physical question is represented by a Hamiltonian or unitary matrix rotating that state between preparation and measurement; the experimental or mathematical setting is the chosen basis, pulse sequence, or measurement axis. The observable content is obtained from projectors onto the two eigenstates of the measured observable. In the local terminology of this topic, the same construction appears through Density matrix or wave function, matrix or Hamiltonian, and eigenvalue or energy level. Probabilities enter only after this spectral decomposition: the Born rule assigns weights to projectors, not to informal object names. When two observables have a non-zero commutator, no single basis diagonalizes both; the limitation is therefore a statement about jointly available spectra, not about detector imperfection. In this page the compatibility condition is expressed through commutator or uncertainty relation.
...
## Evidence Profile
- Routes: operator and spectrum: 0.43, state evolution / transport: 0.24, closure / conservation: 0.17, boundary or preparation: 0.07, update protocol: 0.06, non-commuting transformations: 0.05
...
## Evidence Links
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.512
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.493
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.486
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.481
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.473
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.469
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.465
- [2108.07838](https://arxiv.org/abs/2108.07838) — score 0.448
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.442
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.441

---
Wikipedia scaffold: [Density matrix](https://en.wikipedia.org/wiki/Density_matrix) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
