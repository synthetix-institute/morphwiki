...
## The Standard Story
Quantum statistical mechanics is statistical mechanics applied to quantum mechanical systems. It relies on constructing density matrices that describe quantum systems in thermal equilibrium.
...
- **operator:** observable operator; matrix; Hamiltonian
- **spectrum:** spectrum; eigenvalue
- **boundary:** basis
- **incompatibility:** commutator; uncertainty relation; non-commuting observables
- **protocol:** projection update

## Evidence Profile
- Routes: operator and spectrum: 0.42, state evolution / transport: 0.22, closure / conservation: 0.17, update protocol: 0.06, boundary or preparation: 0.05, non-commuting transformations: 0.04
...
## Evidence Links
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.592
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.589
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.582
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.582
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.581
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.574
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.564
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.559
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.558
- [2108.07838](https://arxiv.org/abs/2108.07838) — score 0.552

---
Wikipedia scaffold: [Quantum statistical mechanics](https://en.wikipedia.org/wiki/Quantum_statistical_mechanics) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
