...
## Mechanism Roles
- **state:** state vector; wavefunction
...
## Evidence Profile
- Routes: operator and spectrum: 0.27, state evolution / transport: 0.27, boundary or preparation: 0.20, closure / conservation: 0.19, non-commuting transformations: 0.11, update protocol: 0.05
...
---
Wikipedia scaffold: [Schrödinger picture](https://en.wikipedia.org/wiki/Schr%C3%B6dinger_picture) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
