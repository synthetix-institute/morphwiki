...
- Spectral terms (spectrum, eigenstate, or eigenvalue) name the outcome labels and projectors that define readout channels.
...
## Mechanism Roles
- **state:** quantum state
- **operator:** matrix; Hamiltonian
- **spectrum:** spectrum; eigenstate; eigenvalue
...
## Evidence Profile
- Routes: operator and spectrum: 0.35, state evolution / transport: 0.23, closure / conservation: 0.17, boundary or preparation: 0.14, update protocol: 0.04, non-commuting transformations: 0.04
...
## Evidence Links
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.587
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.545
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.545
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.540
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.539
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.531
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.527
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.525
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.504
- [0805.4565](https://arxiv.org/abs/0805.4565) — score 0.502

---
Wikipedia scaffold: [Spin network](https://en.wikipedia.org/wiki/Spin_network) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
