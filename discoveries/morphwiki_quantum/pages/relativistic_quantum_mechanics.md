...
## Mechanism Roles
- **state:** wavefunction
- **operator:** Hamiltonian; matrix
- **spectrum:** eigenvalue; energy level; measurement outcome
- **boundary:** potential or domain condition; context
- **incompatibility:** commutator; uncertainty relation; non-commuting observables
- **protocol:** projection update

## Evidence Profile
- Routes: state evolution / transport: 0.27, operator and spectrum: 0.25, closure / conservation: 0.21, boundary or preparation: 0.18, non-commuting transformations: 0.10, update protocol: 0.07
...
## Evidence Links
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.550
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.526
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.523
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.517
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.517
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.515
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.512
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.510
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.507
- [1706.03846](https://arxiv.org/abs/1706.03846) — score 0.506

---
Wikipedia scaffold: [Relativistic quantum mechanics](https://en.wikipedia.org/wiki/Relativistic_quantum_mechanics) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
