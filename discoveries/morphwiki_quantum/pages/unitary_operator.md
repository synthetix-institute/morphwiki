...
## Evidence Status
The unitary operator can be read as a quantum construction: the potential, domain, initial condition, or boundary condition fixes the admissible state space; the Hamiltonian, whose exponential gives unitary time evolution defines the transformation or question; and spectral projectors with the Born rule determine the recorded probability distribution.
...
## Mechanism Form
- Preparation or domain terms (domain, basis, or preparation context) determine which states are admissible.
...
## Evidence Profile
- Routes: operator and spectrum: 0.44, state evolution / transport: 0.24, closure / conservation: 0.18, boundary or preparation: 0.07, update protocol: 0.05, non-commuting transformations: 0.04
...
## Evidence Links
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.500
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.492
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.477
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.471
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.468
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.463
- [2108.07838](https://arxiv.org/abs/2108.07838) — score 0.447
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.442
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.442
- [0805.4565](https://arxiv.org/abs/0805.4565) — score 0.441

---
Wikipedia scaffold: [Unitary operator](https://en.wikipedia.org/wiki/Unitary_operator) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
