...
## Evidence Status
The path integral formulation can be read as a quantum construction: the chosen basis, pulse sequence, or measurement axis fixes the admissible state space; a Hamiltonian or unitary matrix rotating that state between preparation and measurement defines the transformation or question; and spectral projectors with the Born rule determine the recorded probability distribution.

## The Standard Story
The path integral formulation is a description in quantum mechanics that generalizes the stationary action principle of classical mechanics. It replaces the classical notion of a single, unique classical trajectory for a system with a sum, or functional integral, over an infinity of quantum-mechanically possible trajectories to compute a quantum amplitude.

## Mechanism Reading
In quantum-mechanical terms, the Path integral formulation is described by a two-dimensional Hilbert space, usually written as a qubit state or a density matrix. The physical question is represented by a Hamiltonian or unitary matrix rotating that state between preparation and measurement; the experimental or mathematical setting is the chosen basis, pulse sequence, or measurement axis. The observable content is obtained from projectors onto the two eigenstates of the measured observable. In the local terminology of this topic, the same construction appears through superposition or wave function, Hamiltonian or matrix, and eigenvalue or energy level. Probabilities enter only after this spectral decomposition: the Born rule assigns weights to projectors, not to informal object names. When two observables have a non-zero commutator, no single basis diagonalizes both; the limitation is therefore a statement about jointly available spectra, not about detector imperfection. In this page the compatibility condition is expressed through commutator or uncertainty relation.
...
## Mechanism Form
- Preparation or domain terms (basis, context, or domain) determine which states are admissible.
...
## Mechanism Roles
- **state:** superposition
- **operator:** Hamiltonian; matrix; generator; observable operator
- **spectrum:** eigenvalue; energy level; measurement outcome
- **boundary:** basis; context; domain
- **incompatibility:** commutator; uncertainty relation; non-commuting observables
- **protocol:** Path integral

## Evidence Profile
- Routes: operator and spectrum: 0.34, state evolution / transport: 0.25, closure / conservation: 0.19, non-commuting transformations: 0.14, boundary or preparation: 0.12, update protocol: 0.05
...
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.516
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.515
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.514
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.510
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.505
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.501
- [1706.03846](https://arxiv.org/abs/1706.03846) — score 0.479
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.474

---
Wikipedia scaffold: [Path integral formulation](https://en.wikipedia.org/wiki/Path_integral_formulation) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
