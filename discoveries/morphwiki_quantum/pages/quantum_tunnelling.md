...
## Mechanism Form
- Preparation or domain terms (potential or domain condition, domain, or preparation context) determine which states are admissible.
...
- Spectral terms (spectrum, energy level, or eigenvalue) name the outcome labels and projectors that define readout channels.
...
## Mechanism Roles
- **state:** wave function; wavefunction
- **operator:** Hamiltonian; observable operator; generator
- **spectrum:** spectrum; energy level
- **boundary:** potential or domain condition; domain
...
## Evidence Profile
- Routes: operator and spectrum: 0.42, state evolution / transport: 0.24, closure / conservation: 0.18, update protocol: 0.07, boundary or preparation: 0.06, non-commuting transformations: 0.05
...
## Evidence Links
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.569
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.568
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.562
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.558
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.555
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.554
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.549
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.541
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.539
- [0805.4565](https://arxiv.org/abs/0805.4565) — score 0.536

---
Wikipedia scaffold: [Quantum tunnelling](https://en.wikipedia.org/wiki/Quantum_tunnelling) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
