...
## Evidence Profile
- Routes: state evolution / transport: 0.28, closure / conservation: 0.24, operator and spectrum: 0.18, boundary or preparation: 0.06, update protocol: 0.05, non-commuting transformations: 0.05
...
---
Wikipedia scaffold: [Introduction to Quantum Mechanics (book)](https://en.wikipedia.org/wiki/Introduction_to_Quantum_Mechanics_(book)) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
