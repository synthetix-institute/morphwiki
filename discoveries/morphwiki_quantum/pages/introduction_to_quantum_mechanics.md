...
- Compatibility terms (uncertainty relation, complementarity, or commutator) mark cases where observables do not admit one common sharp readout basis.
...
- **boundary:** basis
- **incompatibility:** uncertainty relation; complementarity
- **protocol:** Born rule

## Evidence Profile
- Routes: operator and spectrum: 0.29, state evolution / transport: 0.26, closure / conservation: 0.19, non-commuting transformations: 0.16, update protocol: 0.11, boundary or preparation: 0.07
...
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.462
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.462
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.459
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.458
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.457
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.455
- [1706.03846](https://arxiv.org/abs/1706.03846) — score 0.452

---
Wikipedia scaffold: [Introduction to quantum mechanics](https://en.wikipedia.org/wiki/Introduction_to_quantum_mechanics) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
