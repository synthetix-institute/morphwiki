...
## Mechanism Roles
- **state:** quantum state; wave function; wavefunction; density matrix
...
## Evidence Profile
- Routes: operator and spectrum: 0.37, state evolution / transport: 0.27, closure / conservation: 0.18, boundary or preparation: 0.11, update protocol: 0.10, non-commuting transformations: 0.09
...
---
Wikipedia scaffold: [Quantum decoherence](https://en.wikipedia.org/wiki/Quantum_decoherence) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
