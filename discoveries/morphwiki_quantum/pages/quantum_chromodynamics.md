...
## The Standard Story
In theoretical physics, quantum chromodynamics (QCD) is the study of the strong interaction between quarks mediated by gluons. Quarks are fundamental particles that make up composite hadrons such as the proton, neutron and pion.
...
- **boundary:** context; basis
- **incompatibility:** commutator; uncertainty relation; non-commuting observables
- **protocol:** projection update

## Evidence Profile
- Routes: operator and spectrum: 0.33, state evolution / transport: 0.27, closure / conservation: 0.21, non-commuting transformations: 0.13, update protocol: 0.09, boundary or preparation: 0.09
...
## Evidence Links
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.480
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.480
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.476
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.462
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.455
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.454
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.452
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.452
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.446
- [1706.03846](https://arxiv.org/abs/1706.03846) — score 0.435

---
Wikipedia scaffold: [Quantum chromodynamics](https://en.wikipedia.org/wiki/Quantum_chromodynamics) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
