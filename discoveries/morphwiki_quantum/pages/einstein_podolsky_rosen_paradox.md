...
- Compatibility terms (incompatible observables, uncertainty relation, or commutator) mark cases where observables do not admit one common sharp readout basis.

## Mechanism Roles
- **state:** wave function; quantum state; superposition
...
- **incompatibility:** incompatible observables; uncertainty relation
- **protocol:** unitary evolution; projection or measurement update; path integral weighting

## Evidence Profile
- Routes: state evolution / transport: 0.27, closure / conservation: 0.21, non-commuting transformations: 0.14, boundary or preparation: 0.14, operator and spectrum: 0.14, update protocol: 0.11
...
---
Wikipedia scaffold: [Einstein–Podolsky–Rosen paradox](https://en.wikipedia.org/wiki/Einstein%E2%80%93Podolsky%E2%80%93Rosen_paradox) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
