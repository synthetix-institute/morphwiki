...
## Mechanism Form
- Preparation or domain terms (potential or domain condition, basis, or domain) determine which states are admissible.
...
- **operator:** matrix; Hamiltonian; observable operator
- **spectrum:** eigenvalue; energy level; measurement outcome
- **boundary:** potential or domain condition; basis; domain
...
## Evidence Profile
- Routes: operator and spectrum: 0.43, state evolution / transport: 0.23, closure / conservation: 0.17, boundary or preparation: 0.07, update protocol: 0.05, non-commuting transformations: 0.04
...
---
Wikipedia scaffold: [Self-adjoint operator](https://en.wikipedia.org/wiki/Self-adjoint_operator) (CC BY-SA). Synthesis from Wikipedia scaffold + 32 Hyperion equation witnesses. Not a claim of physical reduction.
