...
## Evidence Status
An observable can be read as a quantum construction: the potential, domain, initial condition, or boundary condition fixes the admissible state space; the Hamiltonian, whose exponential gives unitary time evolution defines the transformation or question; and spectral projectors with the Born rule determine the recorded probability distribution.
...
- Compatibility terms (incompatible observables, complementarity, or commutator) mark cases where observables do not admit one common sharp readout basis.

## Mechanism Roles
- **state:** quantum state
- **operator:** observable operator; Hamiltonian; unitary operator; commutator
- **spectrum:** eigenstate; eigenvalue
- **boundary:** basis
- **incompatibility:** incompatible observables; complementarity; commutator; non-commuting observables
- **protocol:** Born rule
...
## Evidence Links
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.567
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.561
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.522
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.521
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.519
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.517
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.506
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.501
- [2111.12617](https://arxiv.org/abs/2111.12617) — score 0.498
- [0805.4565](https://arxiv.org/abs/0805.4565) — score 0.487

---
Wikipedia scaffold: [Observable](https://en.wikipedia.org/wiki/Observable) (CC BY-SA). Evidence from Wikipedia scaffold and 32 equation witnesses.
