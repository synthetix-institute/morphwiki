...
## Evidence Status
The bell's theorem can be read as a quantum construction: the chosen basis, pulse sequence, or measurement axis fixes the admissible state space; a Hamiltonian or unitary matrix rotating that state between preparation and measurement defines the transformation or question; and spectral projectors with the Born rule determine the recorded probability distribution.
...
## Formal Role
In quantum-mechanical terms, the Bell's theorem is described by a two-dimensional Hilbert space, usually written as a qubit state or a density matrix. The physical question is represented by a Hamiltonian or unitary matrix rotating that state between preparation and measurement; the experimental or mathematical setting is the chosen basis, pulse sequence, or measurement axis. The observable content is obtained from projectors onto the two eigenstates of the measured observable. In the local terminology of this topic, the same construction appears through quantum state or wave function, Hamiltonian or observable operator, and eigenvalue or energy level. Probabilities enter only after this spectral decomposition: the Born rule assigns weights to projectors, not to informal object names. When two observables have a non-zero commutator, no single basis diagonalizes both; the limitation is therefore a statement about jointly available spectra, not about detector imperfection. In this page the compatibility condition is expressed through incompatible observables or commutator.
...
- Compatibility terms (incompatible observables, commutator, or uncertainty relation) mark cases where observables do not admit one common sharp readout basis.
...
- **boundary:** context
- **incompatibility:** incompatible observables
...
## Evidence Links
- [1604.05385](https://arxiv.org/abs/1604.05385) — score 0.511
- [1604.06537](https://arxiv.org/abs/1604.06537) — score 0.472
- [0912.2823](https://arxiv.org/abs/0912.2823) — score 0.466
- [1801.03283](https://arxiv.org/abs/1801.03283) — score 0.445
- [quant-ph0205159](https://arxiv.org/abs/quant-ph/0205159) — score 0.443
- [1612.00682](https://arxiv.org/abs/1612.00682) — score 0.438
- [1506.05598](https://arxiv.org/abs/1506.05598) — score 0.436
- [1708.03640](https://arxiv.org/abs/1708.03640) — score 0.435
- [0908.0752](https://arxiv.org/abs/0908.0752) — score 0.428
- [1706.03846](https://arxiv.org/abs/1706.03846) — score 0.421

---
Wikipedia scaffold: [Bell's theorem](https://en.wikipedia.org/wiki/Bell%27s_theorem) (CC BY-SA). Evidence from Wikipedia scaffold and 32 equation witnesses.
