...
- `page_count`: `146`
- `constructed_pages`: `62`
- `evidence_placements`: `84`
- `mean_operation_gain`: `17.6674`
- `mean_object_shift`: `3.0932`
...
The 62 topic-specific pages already supply local equation skeletons. The 84 core-derived pages mark topics where the book can state the expected quantum ingredients, but still needs a page-native state, operator or map, spectrum or readout, compatibility condition, and realization.
...
Evidence:
- `page_count`: `146`
- `branch_counts`: `{'states': 16, 'measurement': 16, 'fields': 25, 'boundaries': 10, 'protocols': 25, 'annotations': 17, 'observables': 11, 'generators': 16, 'context': 7, 'incompatibility': 3}`
- `constructed_pages`: `62`
- `evidence_placements`: `84`
...
Evidence:
- `protocol_count`: `25`
- `protocol_pages`: Quantum simulator; Quantum cellular automaton; Quantum computing; Quantum circuit; Quantum finite automaton; Quantum channel; Quantum programming; Quantum metrology; Quantum neural network; Quantum machine learning; Quantum complexity theory; Quantum engineering
...
- **Quantum biology** (states): attention `0.533412`, operation gain `19.57`, top roles state=0.30, context=0.18, observable=0.17; anomaly: weak spectral anchor, boundary-driven dynamics, compatibility/closure junction, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Einstein–Podolsky–Rosen paradox** (measurement): attention `0.503868`, operation gain `21.9187`, top roles measurement=0.33, state=0.24, observable=0.14; anomaly: weak spectral anchor, boundary-driven dynamics, compatibility/closure junction, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Scattering** (boundaries): attention `0.498397`, operation gain `22.5734`, top roles boundary=0.25, context=0.21, observable=0.17; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Schrödinger's cat** (states): attention `0.497747`, operation gain `22.5`, top roles state=0.27, context=0.18, measurement=0.18; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Macroscopic quantum phenomena** (states): attention `0.49367`, operation gain `19.6507`, top roles state=0.30, context=0.18, observable=0.17; anomaly: weak spectral anchor, boundary-driven dynamics, multi-role hub, branch-ambiguous
...
- **Delayed-choice quantum eraser** (measurement): attention `0.477297`, operation gain `20.936`, top roles measurement=0.29, state=0.23, observable=0.15; anomaly: weak spectral anchor, compatibility/closure junction, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Quantum nonlocality** (measurement): attention `0.468949`, operation gain `21.2963`, top roles measurement=0.30, state=0.21, context=0.15; anomaly: weak spectral anchor, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Wave–particle duality** (measurement): attention `0.454397`, operation gain `19.1898`, top roles measurement=0.21, state=0.18, context=0.16; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Quantum logic** (observables): attention `0.453234`, operation gain `22.6675`, top roles observable=0.28, context=0.20, measurement=0.19
- **Spin (physics)** (states): attention `0.452864`, operation gain `20.2781`, top roles state=0.31, context=0.19, observable=0.17; anomaly: weak spectral anchor, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Quantum cellular automaton** (protocols): attention `0.447241`, operation gain `16.9956`, top roles state=0.23, context=0.19, measurement=0.19; anomaly: weak spectral anchor, boundary-driven dynamics, multi-role hub, branch-ambiguous
...
- **Fermi–Dirac statistics** (fields): attention `0.446736`, operation gain `14.9718`, top roles state=0.21, context=0.18, fields=0.16; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Quantum chaos** (generators): attention `0.443645`, operation gain `22.1823`, top roles state=0.22, generator=0.19, context=0.18

## Branch-Level Transition

- **Fields, constraints, and scale**: `25` pages, `16` constructed, mean operation gain `14.4538`.
- **Control sequences and quantum channels**: `25` pages, `7` constructed, mean operation gain `15.9004`.
- **Annotations: history, interpretations, and popular frames**: `17` pages, `0` constructed, mean operation gain `23.2335`.
- **Quantum states and subsystem structure**: `16` pages, `7` constructed, mean operation gain `16.3391`.
- **Measurement, instruments, and probabilities**: `16` pages, `8` constructed, mean operation gain `18.9835`.
- **Dynamics and transformations**: `16` pages, `8` constructed, mean operation gain `18.8624`.
- **Observables and spectra**: `11` pages, `6` constructed, mean operation gain `17.2785`.
- **Boundaries and operator domains**: `10` pages, `3` constructed, mean operation gain `20.7498`.
- **State space, domain, and representation**: `7` pages, `4` constructed, mean operation gain `17.4514`.
- **Noncommuting observables**: `3` pages, `3` constructed, mean operation gain `12.9784`.
