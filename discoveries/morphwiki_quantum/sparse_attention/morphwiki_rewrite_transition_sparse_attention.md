...
- `evidence_placements`: `1`
- `mean_operation_gain`: `21.9802`
- `mean_object_shift`: `3.6936`
...
Evidence:
- `page_count`: `146`
- `branch_counts`: `{'generators': 22, 'states': 24, 'measurement': 10, 'annotations': 16, 'incompatibility': 6, 'boundaries': 12, 'fields': 21, 'protocols': 18, 'observables': 10, 'context': 7}`
- `constructed_pages`: `145`
- `evidence_placements`: `1`
...
- **Quantum logic** (generators): attention `0.601514`, operation gain `26.2431`, top roles measurement=0.26, context=0.19, state=0.16; anomaly: compatibility/closure junction, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Quantum biology** (generators): attention `0.558091`, operation gain `23.2452`, top roles context=0.19, observable=0.19, measurement=0.17; anomaly: weak spectral anchor, boundary-driven dynamics, compatibility/closure junction, protocol is unusually explicit, multi-role hub
...
- **Schrödinger's cat** (states): attention `0.556623`, operation gain `26.2446`, top roles measurement=0.26, context=0.19, state=0.19; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Measurement problem** (measurement): attention `0.546962`, operation gain `26.873`, top roles measurement=0.31, context=0.18, state=0.16; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub
...
- **Delayed-choice quantum eraser** (measurement): attention `0.542125`, operation gain `26.6304`, top roles measurement=0.26, context=0.18, state=0.17; anomaly: weak spectral anchor, compatibility/closure junction, protocol is unusually explicit, multi-role hub
...
- **Introduction to quantum mechanics** (annotations): attention `0.540461`, operation gain `21.1268`, top roles measurement=0.21, context=0.21, state=0.19; anomaly: weak spectral anchor, compatibility/closure junction, protocol is unusually explicit, multi-role hub, branch-ambiguous
...
- **Einstein–Podolsky–Rosen paradox** (incompatibility): attention `0.533228`, operation gain `24.3902`, top roles measurement=0.26, context=0.18, state=0.17; anomaly: weak spectral anchor, boundary-driven dynamics, compatibility/closure junction, protocol is unusually explicit, multi-role hub
...
- **Quantum nonlocality** (incompatibility): attention `0.523908`, operation gain `26.3015`, top roles measurement=0.27, context=0.18, state=0.16; anomaly: weak spectral anchor, protocol is unusually explicit, multi-role hub
...
- **Wave–particle duality** (states): attention `0.515936`, operation gain `24.2009`, top roles context=0.19, observable=0.19, measurement=0.16; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub
...
- **Scattering** (boundaries): attention `0.506669`, operation gain `23.3878`, top roles context=0.19, observable=0.17, measurement=0.16; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub
...
- **Quantum gravity** (fields): attention `0.505617`, operation gain `23.2505`, top roles observable=0.20, context=0.19, state=0.16; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub
...
- **Quantum simulator** (states): attention `0.494871`, operation gain `20.4403`, top roles context=0.20, measurement=0.20, state=0.19; anomaly: weak spectral anchor, protocol is unusually explicit, multi-role hub
...
- **Fermi–Dirac statistics** (fields): attention `0.494707`, operation gain `22.5045`, top roles context=0.20, measurement=0.19, state=0.19; anomaly: weak spectral anchor, boundary-driven dynamics, protocol is unusually explicit, multi-role hub
...
- **Quantum Theory: Concepts and Methods** (annotations): attention `0.47483`, operation gain `25.2604`, top roles measurement=0.28, context=0.18, state=0.16
- **Spin (physics)** (states): attention `0.474605`, operation gain `22.1119`, top roles context=0.21, measurement=0.20, state=0.19; anomaly: weak spectral anchor, protocol is unusually explicit, multi-role hub
...
- **Quantum computing** (protocols): attention `0.470529`, operation gain `21.4612`, top roles context=0.20, measurement=0.20, state=0.18; anomaly: weak spectral anchor, protocol is unusually explicit, multi-role hub
...
- **Wave function** (states): attention `0.470049`, operation gain `20.8678`, top roles state=0.27, measurement=0.22, context=0.20; anomaly: weak spectral anchor, compatibility/closure junction, protocol is unusually explicit, multi-role hub
...
- **Quantum electrodynamics** (fields): attention `0.469412`, operation gain `21.7195`, top roles measurement=0.22, context=0.20, observable=0.18; anomaly: weak spectral anchor, boundary-driven dynamics, compatibility/closure junction, multi-role hub
...
- **Quantum field theory** (fields): attention `0.45692`, operation gain `20.4082`, top roles context=0.20, measurement=0.17, state=0.16; anomaly: weak spectral anchor, boundary-driven dynamics, compatibility/closure junction, multi-role hub
...
- **Electron microscope** (observables): attention `0.454225`, operation gain `31.7404`, top roles observable=0.27, state=0.19, measurement=0.13

## Branch-Level Transition

- **State carrier inside Hilbert space**: `24` pages, `24` constructed, mean operation gain `21.2461`.
- **Generator: lawful change before readout**: `22` pages, `22` constructed, mean operation gain `22.588`.
- **Many-mode extension: fields, particles, and scaling**: `21` pages, `21` constructed, mean operation gain `21.5769`.
- **Protocol layer: engineered transformations**: `18` pages, `18` constructed, mean operation gain `20.9139`.
- **Annotations: history, interpretations, and popular frames**: `16` pages, `16` constructed, mean operation gain `23.2621`.
- **Boundary realization: how effects appear**: `12` pages, `12` constructed, mean operation gain `22.4602`.
- **Readout rule: how answers become probabilities**: `10` pages, `10` constructed, mean operation gain `22.884`.
- **Spectral question: what can be asked**: `10` pages, `9` constructed, mean operation gain `21.4894`.
- **Hilbert-space context: admissible carrier and basis**: `7` pages, `7` constructed, mean operation gain `22.6736`.
- **Compatibility limit: what cannot be jointly sharp**: `6` pages, `6` constructed, mean operation gain `21.4226`.
