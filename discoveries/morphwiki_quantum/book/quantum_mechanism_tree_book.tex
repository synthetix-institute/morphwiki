...
{\large Generated 2026-09-01 17:12 UTC\par}
...
Source citations are included only for topic-level equation witnesses confirmed by source-card alignment. The present source-card export confirms none: 111 topics have identifier-linked candidates awaiting equation-level confirmation, and 35 have no aligned candidate. The repository contains the generated tree, topic records, derivation pages, build scripts, and preservation report needed to reproduce this edition.
