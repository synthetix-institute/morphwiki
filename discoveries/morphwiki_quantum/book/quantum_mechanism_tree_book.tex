...
{\large Full reference edition\par}
...
Physical-role overviews locate additional subjects within the same organization. Their shared representative equations are identified as such. The shorter expository companion retains the topic-specific treatments and places these overviews in a reference index.
...
\subsection*{Mechanism}
Spin (physics) is placed at the state step, where the carrier of prediction is specified: the object that is propagated, transformed, restricted, or measured.
...
\subsection*{Mechanism}
Dirac equation is placed at the many-mode extension, where the same state, generator, observable, and compatibility logic is lifted from one system to fields, particles, scaling limits, or gauge constraints.
