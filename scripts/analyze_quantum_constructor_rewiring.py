...
CONNECTIONS: List[Dict[str, Any]] = [
    {
        ...
        "rewiring": "read the same operator through its exponential for transport and through its spectral measure for energy readout",
    ...
    },
    {
        ...
        "title": "Constraints define physical readout",
    ...
    },
    {
        ...
        "rewiring": "encode one carrier in another and require the encoding to intertwine the relevant dynamics and readouts",
